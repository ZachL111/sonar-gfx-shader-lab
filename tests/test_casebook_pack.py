"""Regression checks for the sonar-gfx-shader-lab casebook."""
...
from casebook.harness import assert_expected, sonar_gfx_shader_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(sonar_gfx_shader_lab_summary(), assert_expected())
