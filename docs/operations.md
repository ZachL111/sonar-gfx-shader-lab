...
`sonar-gfx-shader-lab` is centered on graphics work in Dart. The technical target is: Design a Dart verification harness for shader systems, covering storage recovery, log and snapshot fixtures, and failure-oriented tests.
